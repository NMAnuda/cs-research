...
"[project]/src/app/(policeman)/login2/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Login() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError(null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:3080/login2', {
                district,
                city,
                ID: id
            });
...
_s(Login, "ByjT42Ax1tQNfOigMoRKgQzfjIQ=");
_c = Login;
var _c;
...
//# sourceMappingURL=src_app_%28policeman%29_login2_page_17acc102.js.map